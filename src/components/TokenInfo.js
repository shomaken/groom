          ...
          <div className="buy-options">
            ...
            >
              ...
              <p>The primary marketplace for $GROOM tokens</p>
                                <a href="https://bagsapp.com/token/3ofiPaQdD6GcspNXSk6xQqB1wzEtJALikfcSmeqqBAGS" className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                Buy on BagsApp
              </a>
            </motion.div>
            ...
            >
              ...
              <p>View live charts and trading data</p>
                                <a href="https://birdeye.so/token/3ofiPaQdD6GcspNXSk6xQqB1wzEtJALikfcSmeqqBAGS" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Chart
              </a>
            </motion.div>
            ...
            >
              ...
              <p>Explore token and transactions</p>
                                <a href="https://solscan.io/token/3ofiPaQdD6GcspNXSk6xQqB1wzEtJALikfcSmeqqBAGS" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Token
              </a>
            </motion.div>
          </div>
