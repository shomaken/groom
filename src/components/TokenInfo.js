...
const TokenInfo = ({ onNext, onPrev }) => {
  ...
  const tokenAddress = "81KzC6LsZEN4BGcMRcg5BoanAsXk4ctP8gFhQDweBAGS"; // GROOM token address
        ...
        >
          ...
          <div className="buy-options">
            ...
            >
              ...
              <a href="https://bagsapp.com/token/81KzC6LsZEN4BGcMRcg5BoanAsXk4ctP8gFhQDweBAGS" className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                Buy on BagsApp
              </a>
            </motion.div>
            ...
            >
              ...
              <a href="https://birdeye.so/token/81KzC6LsZEN4BGcMRcg5BoanAsXk4ctP8gFhQDweBAGS" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Chart
              </a>
            </motion.div>
            ...
            >
              ...
              <a href="https://solscan.io/token/81KzC6LsZEN4BGcMRcg5BoanAsXk4ctP8gFhQDweBAGS" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Token
              </a>
            </motion.div>
          </div>
