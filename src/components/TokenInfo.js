...
const TokenInfo = ({ onNext, onPrev }) => {
  ...
  const tokenAddress = "YOUR_SOLANA_TOKEN_ADDRESS_HERE"; // Replace with actual Solana token address
        ...
        >
          ...
          <div className="buy-options">
            ...
            >
              ...
              <a href="https://bagsapp.com/token/YOUR_SOLANA_TOKEN_ADDRESS_HERE" className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                Buy on BagsApp
              </a>
            </motion.div>
            ...
            >
              ...
              <a href="https://birdeye.so/token/YOUR_SOLANA_TOKEN_ADDRESS_HERE" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Chart
              </a>
            </motion.div>
            ...
            >
              ...
              <a href="https://solscan.io/token/YOUR_SOLANA_TOKEN_ADDRESS_HERE" className="btn btn-secondary" target="_blank" rel="noopener noreferrer">
                View Token
              </a>
            </motion.div>
          </div>
